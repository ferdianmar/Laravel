...
<div class="container">
    <div class="row">
        ...
        <div class="col">
            <div class="card mb-3">
                <div class="card-body">
                    <a href="" data-toggle="modal" data-target="#logoutModal" class="btn btn-sm btn-success"><i class="fa fa-plus"></i> Tambah Menu</a>
                </div>
            </div>
        </div>
        <div class="col-lg-12">
                                ...
                                <div class="row no-gutters align-items-center">
                                    <div class="col mr-2">
                                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            Pelangan</div>
                                        <?php
                                        $pelanggan = \App\Models\User::where('level', 3)->get()->count();
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center"> 
                                            <a href="{{url('/terimaorder')}}/{{$pesanan_details->id}}" class="btn btn-success btn-sm"><span><i class="fa fa-check"></i> Terima Order</span></a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
