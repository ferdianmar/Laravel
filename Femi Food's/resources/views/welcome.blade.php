...
<body id="page-top" class="theme">
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background-color: #ffa366">
        <div class="container">
            <a class="navbar-brand text-white" href=""><span class="font-weight-bold"> <i style="color: black; font-size: 30px;" class="fas fa-utensils"> Femi</i> Food's</span></a>
    ...
    <div id="carouselExampleIndicators" class="carousel slide mb-4" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-caption d-none d-md-block">
                <h1 class="display-4"> <span class="font-weight-bold"> <i class="fas fa-utensils"></i> Femi </span> Food's </h1>
                <hr class="my-4">
                <p>Ukhti Kenyang Kami Puas !</p>
    ...
    <footer>
        <div class="container-fluid" style="background-color: tomato;">
            <div class="row">
                <div class="col-12">
                    <h6 class="text-center text-white">Copyright &copy; Femi Food's {{date('Y')}} </h6>
                </div>
            </div>
        </div>
        </div>
