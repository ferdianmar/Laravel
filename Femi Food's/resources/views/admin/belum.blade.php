        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Transaksi - Belum Bayar</li>
                </ol>
            </nav>
        </div>
        <!-- Begin Page Content -->
                            ...
                            <table class="table table-hover" id="dataTable">
                                ...
                                <tbody align="left">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">@if ($transaksi->status == 1)
                                            <span class="badge badge-danger"> Belum Bayar </span>
                                            @endif
                                        </td>
                                        <td class="text-center">
                                            <a href="{{url('/admin/transaksi/acc')}}/{{$transaksi->pesanan_id}}" class="btn btn-success"> Accept</a>
                                            <a href="{{url('/admin/transaksi')}}/{{$transaksi->pesanan_id}}" class="btn btn-info"> Detail</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
