    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav" style="background-color: #ffa366">
                <div class="container">
                    <a class="navbar-brand text-white" href=""><span class="font-weight-bold"> <i style="color: black; font-size: 30px;" class="fas fa-utensils"> Femi</i> Food</span></a>
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <div>
                                        <a class="dropdown-item" href="{{url('dashboard')}}">
                                            <i class="fab fa-amazon-pay fa-fw mr-2 text-gray-400"></i>
                                            Dashboard</a>
