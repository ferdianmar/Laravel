...
class KasirController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('kasir.dashboard', compact('datauser', 'pesanan_details'));
    }

    public function datapelanggan()
    {
        return view('kasir.datapelanggan', ['users' => User::where('level', 2)->get()]);
    }
    public function datatransaksi()
    {
        ...
        return view('kasir.datatransaksi', compact('transaksi'));
    }
