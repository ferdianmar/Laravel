...
<body id="page-top">
	...
	<div id="wrapper">
			...
			<li class="nav-item">
				...
				<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item" href="index.php">Pelanggan</a>
		...
		if(isset($_POST['submit'])){
			...
			$cek = mysqli_query($koneksi, "SELECT * FROM pelanggan WHERE nama='$nama'") or die(mysqli_error($koneksi));
			
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO pelanggan(nama, alamat, no_hp) VALUES('$nama', '$alamat', '$no_hp')") or die(mysqli_error($koneksi));
				...
				echo '<div class="alert alert-warning">Gagal, Pelanggan sudah terdaftar.</div>';
			}
		}
		?>
