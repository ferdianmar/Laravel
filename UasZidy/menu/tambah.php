...
<body id="page-top">
    ...
    <div id="wrapper">
		...
		if(isset($_POST['submit'])){
			...
			$cek = mysqli_query($koneksi, "SELECT * FROM menu WHERE nama='$nama'") or die(mysqli_error($koneksi));
			
			if(mysqli_num_rows($cek) == 0){
				$sql = mysqli_query($koneksi, "INSERT INTO menu(nama, stok, harga) VALUES('$nama', '$stok', '$harga')") or die(mysqli_error($koneksi));
				...
				echo '<div class="alert alert-warning">Gagal, Menu sudah terdaftar.</div>';
			}
		}
		?>
