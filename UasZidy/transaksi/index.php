    ...
    <div id="wrapper">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="index.php">Transaksi</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				$sql = mysqli_query($koneksi, "SELECT t.tanggal, t.id, p.nama as namaP, m.nama as namaM, t.jumlah, t.total
                FROM ((transaksi t INNER JOIN pelanggan p ON t.nama_pelanggan = p.id) INNER JOIN menu m ON t.nama_menu = m.id)") or die(mysqli_error($koneksi));
				...
				if(mysqli_num_rows($sql) > 0){
					...
					while($data = mysqli_fetch_assoc($sql)){
						...
						<tr>
							...
							<td class="text-center">'.$data['namaP'].'</td>
							<td class="text-center">'.$data['namaM'].'</td>
