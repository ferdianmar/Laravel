            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="menu/index.php">Menu</a>
                    ...
                    <div class="container">
                        <div class="card text-center mt-5">
                            <div class="card-header"
                                style="font-size : 30px;font-weight : bold;color : white; background-color: #9932CC;">
                                Transaksi
                            </div>
                            <div class="card-body">
                                ...
                                if(isset($_POST['submit'])){
                                    ...
                                    $sql2 = mysqli_query($koneksi, "SELECT * FROM menu WHERE id='$nama_menu'") or die(mysqli_error($koneksi));
                                    ...
                                    if($update >= 0){
                                        $sql = mysqli_query($koneksi, "INSERT INTO transaksi(nama_pelanggan, nama_menu, jumlah, total,tanggal) VALUES('$nama_pelanggan', '$nama_menu', '$jumlah','$total','$tanggal')") or die(mysqli_error($koneksi));
                                        $sql3 = mysqli_query($koneksi, "UPDATE menu SET stok='$update' WHERE id='$nama_menu'") or die(mysqli_error($koneksi));
                                        if($sql && $sql3){
                                        ...
                                        echo '<div class="alert alert-warning">Maaf Stok Menu Tidak Mencukupi !!! Harap Pilih Menu Lain</div>';
                                    }
                                }
                                ?>
                                    ...
                                    <form action="index.php" method="post">
                                        ...
                                        <div class="form-group row mt-2">
                                            ...
                                            <div class="col-sm-5">
                                                <select name="pelanggan" class="form-control" required>
                                                    ...
                                                    <?php
                                                        $sql = mysqli_query($koneksi, "SELECT * FROM pelanggan ORDER BY id asc") or die(mysqli_error($koneksi));
                                        ...
                                        <div class="form-group row mt-2">
                                            <label class="col-sm-5 col-form-label">NAMA MENU</label>
                                            <div class="col-sm-5">
                                                <select name="menu" class="form-control" required>

                                                    <?php
                                            $sql = mysqli_query($koneksi, "SELECT * FROM menu ORDER BY id asc") or die(mysqli_error($koneksi));
                                            if(mysqli_num_rows($sql) > 0){
                                                while($data = mysqli_fetch_assoc($sql)){
                                                    echo'
                                                        <option value="'.$data['id'].'">'.$data['nama'].'</option>
