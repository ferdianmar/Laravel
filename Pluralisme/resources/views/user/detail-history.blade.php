...
<div class="container">
        ...
        @if ($pesanans->status < 2) <div class="col-lg-12 mb-3">
            <div class="card">
                <div class="card-body shadow-sm">
                    ...
                    <div>&bull; Pembayaran orderan dapat melalui <b><code>Bank BCA (014), No Rek : 0123548679 an Pluralisme Brand's</code></b></div>
                    <div>&bull; <b>
    ...
    <div class="col-lg-12">
        <div class="card p-4 shadow-sm">
            <h3 class="text-center"><i class="fa fa-shopping-cart"> Invoice Pluralisme Brand's</i></h3>
            @if (!empty($pesanans))
