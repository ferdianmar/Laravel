...
<body id="page-top" class="theme">
    ...
    <div id="carouselExampleIndicators" class="carousel slide mb-4" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="carousel-item active">
                ...
                <img src="{{url('/')}}/img/slide1.jpg" class="d-block w-100 mt-3 " alt="...">
            </div>

            <div class="carousel-caption d-none d-md-block">
                <h1 class="display-4" style="text-shadow: 4px 4px #000000"> <span class="font-weight-bold"> <i class="fab fa-battle-net"></i> PLURALISME </span> Brand's </h1>
                <hr class="my-4" >
                <p style="text-shadow: 1px 1px #000000">Ayo Order Sebelum Kehabisan !</p>
                <a class="btn btn-dark btn-lg " href="{{ route('login') }}" role="button"> <span class="font-weight-bold">Order Sekarang</span> </a>
            ...
            <div class="carousel-item">
                <img src="{{url('/')}}/img/slide3.jpg" class="d-block w-100 mt-5" alt="...">
            </div>
        </div>
            ...
            <div class="col-lg-3 ml-5">
                <div class="card p-1 " style="width: 20rem; margin-top: -150px; margin-bottom: 50px;">
                    ...
                    <div class="card-body">
                        ...
                        <span class="badge badge-dark"> Terfavorite</span>
                    </div>
                </div>
            </div>
            @endforeach
    ...
    <footer>
        <div class="container-fluid shadow-lg rounded" style="background-color: black;">
            <div class="row">
                <div class="col-12">
                    <h6 class="text-center text-white">Copyright &copy; Pluralisme Brand's {{date('Y')}} </h6>
                </div>
            </div>
        </div>
        </div>
